...
VL_INLINE_OPT void VPWMTest::_sequent__TOP__1(VPWMTest__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/meghag/Chisel/test_run_dir/PWMTest/201906271435533028697624506615320/PWMTest.v:358
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((((IData)(vlTOPp->PWMTest__DOT___GEN_154) 
			  & (~ (IData)(vlTOPp->PWMTest__DOT___T_447))) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FWRITEF(0x80000002U,"    failed on step %2# -- port out:  %1# expected %1#\n",
		       ...
		       1,((0x24U == (IData)(vlTOPp->PWMTest__DOT__value)) 
			  | ((0x23U != (IData)(vlTOPp->PWMTest__DOT__value)) 
			     & ((0x22U != (IData)(vlTOPp->PWMTest__DOT__value)) 
				& ((0x21U != (IData)(vlTOPp->PWMTest__DOT__value)) 
				   & ((0x20U != (IData)(vlTOPp->PWMTest__DOT__value)) 
				      & ((0x1fU != (IData)(vlTOPp->PWMTest__DOT__value)) 
					 & ((0x1eU 
								 ...
								 & ((0x16U 
									...
									== (IData)(vlTOPp->PWMTest__DOT__value)) 
									  ...
									  & ((0x13U 
										...
										& ((0xcU 
										!= (IData)(vlTOPp->PWMTest__DOT__value)) 
										& (IData)(vlTOPp->PWMTest__DOT___GEN_85)))))))))))))))))))))))))));
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((((IData)(vlTOPp->PWMTest__DOT___GEN_154) 
	...
	if (VL_UNLIKELY((((IData)(vlTOPp->PWMTest__DOT___GEN_154) 
			  & (~ (IData)(vlTOPp->PWMTest__DOT___T_447))) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_WRITEF("[%0t] %%Error: PWMTest.v:406: Assertion failed in %NPWMTest\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/meghag/Chisel/test_run_dir/PWMTest/201906271435533028697624506615320/PWMTest.v",406,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((((IData)(vlTOPp->PWMTest__DOT___GEN_154) 
			  & (~ (IData)(vlTOPp->PWMTest__DOT___T_447))) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/meghag/Chisel/test_run_dir/PWMTest/201906271435533028697624506615320/PWMTest.v",417,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((((~ (IData)(vlTOPp->PWMTest__DOT___T_9)) 
			 ...
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FWRITEF(0x80000002U,"Stopping, end of tests, 37 steps\n");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((((~ (IData)(vlTOPp->PWMTest__DOT___T_9)) 
			  & (0x24U == (IData)(vlTOPp->PWMTest__DOT__value))) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/meghag/Chisel/test_run_dir/PWMTest/201906271435533028697624506615320/PWMTest.v",439,"");
	}
    }
    // ALWAYS at /home/meghag/Chisel/test_run_dir/PWMTest/201906271435533028697624506615320/PWMTest.v:63
	...
	if ((1U & (~ (IData)(vlTOPp->PWMTest__DOT___T_9)))) {
	    __Vdly__PWMTest__DOT__value = ((IData)(vlTOPp->PWMTest__DOT___T_461)
					    ? 0U : (IData)(vlTOPp->PWMTest__DOT___T_464));
	}
    }
    // ALWAYS at /home/meghag/Chisel/test_run_dir/PWMTest/201906271435533028697624506615320/PWMTest.v:63
    if (vlTOPp->reset) {
	...
	if (vlTOPp->PWMTest__DOT___T_11) {
	    if ((0x24U == (IData)(vlTOPp->PWMTest__DOT__value))) {
    ...
    vlTOPp->PWMTest__DOT___T_461 = (0x24U == (IData)(vlTOPp->PWMTest__DOT__value));
    vlTOPp->PWMTest__DOT___T_464 = (0x3fU & ((IData)(1U) 
					     + (IData)(vlTOPp->PWMTest__DOT__value)));
								 ...
								 ((0x15U 
								  ...
								  ((0x14U 
								   ...
								   ((0x13U 
								     ...
								     ? 1U
								     : 7U))))))))))))))))))));
    vlTOPp->PWMTest__DOT___GEN_85 = ((0xbU == (IData)(vlTOPp->PWMTest__DOT__value)) 
				     | ((0xaU == (IData)(vlTOPp->PWMTest__DOT__value)) 
					| ((9U == (IData)(vlTOPp->PWMTest__DOT__value)) 
					   | ((8U == (IData)(vlTOPp->PWMTest__DOT__value)) 
					      | ((7U 
						  == (IData)(vlTOPp->PWMTest__DOT__value)) 
						 | ((6U 
						     == (IData)(vlTOPp->PWMTest__DOT__value)) 
							...
							== (IData)(vlTOPp->PWMTest__DOT__value)) 
							  ...
							  | ((3U 
								...
								| (1U 
								   == (IData)(vlTOPp->PWMTest__DOT__value))))))))))));
    vlTOPp->PWMTest__DOT___T_447 = ((IData)(vlTOPp->PWMTest__DOT__c__DOT__out) 
				    == ((0x24U == (IData)(vlTOPp->PWMTest__DOT__value)) 
					| ((0x23U != (IData)(vlTOPp->PWMTest__DOT__value)) 
					   & ((0x22U 
					       != (IData)(vlTOPp->PWMTest__DOT__value)) 
								...
								& ((0x1bU 
								   ...
								   & ((0x1aU 
									 ...
									 & ((0x18U 
										...
										!= (IData)(vlTOPp->PWMTest__DOT__value)) 
										& (IData)(vlTOPp->PWMTest__DOT___GEN_85)))))))))))))))))))))))))));
    vlTOPp->PWMTest__DOT___GEN_154 = ((~ (IData)(vlTOPp->PWMTest__DOT___T_9)) 
				      & ((0x24U == (IData)(vlTOPp->PWMTest__DOT__value)) 
					 | ((0x23U 
					     == (IData)(vlTOPp->PWMTest__DOT__value)) 
					    | ((0x22U 
...
void VPWMTest::_ctor_var_reset() {
    ...
    PWMTest__DOT___GEN_85 = VL_RAND_RESET_I(1);
    PWMTest__DOT___T_447 = VL_RAND_RESET_I(1);
    PWMTest__DOT___T_461 = VL_RAND_RESET_I(1);
    PWMTest__DOT___T_464 = VL_RAND_RESET_I(6);
    PWMTest__DOT___GEN_154 = VL_RAND_RESET_I(1);
