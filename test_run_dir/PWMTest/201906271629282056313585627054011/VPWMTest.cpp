...
VL_INLINE_OPT void VPWMTest::_sequent__TOP__1(VPWMTest__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at /home/meghag/Chisel/test_run_dir/PWMTest/201906271629282056313585627054011/PWMTest.v:452
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((((IData)(vlTOPp->PWMTest__DOT___GEN_174) 
			  & (IData)(vlTOPp->PWMTest__DOT___T_502)) 
			 & (~ (IData)(vlTOPp->reset))))) {
	...
	if (VL_UNLIKELY((((IData)(vlTOPp->PWMTest__DOT___GEN_174) 
	    ...
	    VL_FWRITEF(0x80000002U,"    failed on step %2# -- port out:  %1# expected %1#\n",
		       6,vlTOPp->PWMTest__DOT__value,
		       1,(IData)(vlTOPp->PWMTest__DOT__c__DOT__out),
		       1,((0x29U == (IData)(vlTOPp->PWMTest__DOT__value)) 
			  | ((0x28U != (IData)(vlTOPp->PWMTest__DOT__value)) 
			     & ((0x27U != (IData)(vlTOPp->PWMTest__DOT__value)) 
					 ...
					 | ((0x23U 
						...
						== (IData)(vlTOPp->PWMTest__DOT__value)) 
						  ...
						  | ((0x20U 
							...
							| ((0x1eU 
							    == (IData)(vlTOPp->PWMTest__DOT__value)) 
							   | (IData)(vlTOPp->PWMTest__DOT___GEN_155))))))))))))));
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((((IData)(vlTOPp->PWMTest__DOT___GEN_174) 
	...
	if (VL_UNLIKELY((((IData)(vlTOPp->PWMTest__DOT___GEN_174) 
			  & (~ (IData)(vlTOPp->PWMTest__DOT___T_502))) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_WRITEF("[%0t] %%Error: PWMTest.v:511: Assertion failed in %NPWMTest\n",
		      64,VL_TIME_Q(),vlSymsp->name());
	    VL_STOP_MT("/home/meghag/Chisel/test_run_dir/PWMTest/201906271629282056313585627054011/PWMTest.v",511,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((((IData)(vlTOPp->PWMTest__DOT___GEN_174) 
			  & (~ (IData)(vlTOPp->PWMTest__DOT___T_502))) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/meghag/Chisel/test_run_dir/PWMTest/201906271629282056313585627054011/PWMTest.v",522,"");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((((~ (IData)(vlTOPp->PWMTest__DOT___T_9)) 
			  & (0x29U == (IData)(vlTOPp->PWMTest__DOT__value))) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FWRITEF(0x80000002U,"Stopping, end of tests, 42 steps\n");
	}
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
	if (VL_UNLIKELY((((~ (IData)(vlTOPp->PWMTest__DOT___T_9)) 
			  & (0x29U == (IData)(vlTOPp->PWMTest__DOT__value))) 
			 & (~ (IData)(vlTOPp->reset))))) {
	    VL_FINISH_MT("/home/meghag/Chisel/test_run_dir/PWMTest/201906271629282056313585627054011/PWMTest.v",544,"");
	}
    }
    // ALWAYS at /home/meghag/Chisel/test_run_dir/PWMTest/201906271629282056313585627054011/PWMTest.v:63
	...
	if ((1U & (~ (IData)(vlTOPp->PWMTest__DOT___T_9)))) {
	    __Vdly__PWMTest__DOT__value = ((IData)(vlTOPp->PWMTest__DOT___T_519)
					    ? 0U : (IData)(vlTOPp->PWMTest__DOT___T_522));
	}
    }
    // ALWAYS at /home/meghag/Chisel/test_run_dir/PWMTest/201906271629282056313585627054011/PWMTest.v:63
    if (vlTOPp->reset) {
	...
	if (vlTOPp->PWMTest__DOT___T_11) {
	    if ((0x29U == (IData)(vlTOPp->PWMTest__DOT__value))) {
    ...
    vlTOPp->PWMTest__DOT___T_519 = (0x29U == (IData)(vlTOPp->PWMTest__DOT__value));
    vlTOPp->PWMTest__DOT___T_522 = (0x3fU & ((IData)(1U) 
					     + (IData)(vlTOPp->PWMTest__DOT__value)));
    vlTOPp->PWMTest__DOT___GEN_29 = ((0x1dU == (IData)(vlTOPp->PWMTest__DOT__value))
				      ? 4U : ((0x1cU 
					       == (IData)(vlTOPp->PWMTest__DOT__value))
					       ? 4U
					       : ((0x1bU 
								...
								((0xcU 
								 ...
								 ((0xbU 
								  ...
								  ((0xaU 
								    ...
								    ? 4U
								    : 6U))))))))))))))))))));
    vlTOPp->PWMTest__DOT___GEN_71 = ((0x1dU == (IData)(vlTOPp->PWMTest__DOT__value))
				      ? 0xbU : ((0x1cU 
						 == (IData)(vlTOPp->PWMTest__DOT__value))
						 ? 0xbU
						 : 
							   ...
							   ((0x10U 
								...
								((0xbU 
								 ...
								 ((0xaU 
								   ...
								   ? 0xcU
								   : 3U))))))))))))))))))));
    vlTOPp->PWMTest__DOT___GEN_87 = ((3U == (IData)(vlTOPp->PWMTest__DOT__value)) 
				     | ((2U == (IData)(vlTOPp->PWMTest__DOT__value)) 
					| (1U == (IData)(vlTOPp->PWMTest__DOT__value))));
							   ...
							   ((0x20U 
							    ...
							    ((0x1fU 
							     ...
							     ((0x1eU 
							       == (IData)(vlTOPp->PWMTest__DOT__value))
							       ? 0xbU
							       : (IData)(vlTOPp->PWMTest__DOT___GEN_71))))))))))))))
					    : ((IData)(vlTOPp->PWMTest__DOT__c__DOT__counter) 
					       == (
						   (0x29U 
						    == (IData)(vlTOPp->PWMTest__DOT__value))
							   ...
							   ((0x20U 
							    ...
							    ((0x1fU 
							     ...
							     ((0x1eU 
							       == (IData)(vlTOPp->PWMTest__DOT__value))
							       ? 4U
							       : (IData)(vlTOPp->PWMTest__DOT___GEN_29)))))))))))))));
    vlTOPp->PWMTest__DOT___GEN_113 = ((0x1dU == (IData)(vlTOPp->PWMTest__DOT__value)) 
				      | ((0x1cU == (IData)(vlTOPp->PWMTest__DOT__value)) 
					 | ((0x1bU 
					     == (IData)(vlTOPp->PWMTest__DOT__value)) 
					    | ((0x1aU 
						== (IData)(vlTOPp->PWMTest__DOT__value)) 
								 ...
								 | ((0x13U 
									...
									== (IData)(vlTOPp->PWMTest__DOT__value)) 
									  ...
									  | ((0x10U 
										...
										| ((4U 
										== (IData)(vlTOPp->PWMTest__DOT__value)) 
										| (IData)(vlTOPp->PWMTest__DOT___GEN_87)))))))))))))))))))))))))));
    vlTOPp->PWMTest__DOT___GEN_155 = ((0x1dU == (IData)(vlTOPp->PWMTest__DOT__value)) 
				      | ((0x1cU == (IData)(vlTOPp->PWMTest__DOT__value)) 
					 | ((0x1bU 
					     == (IData)(vlTOPp->PWMTest__DOT__value)) 
					    | ((0x1aU 
								 ...
								 | ((0x13U 
									...
									== (IData)(vlTOPp->PWMTest__DOT__value)) 
									  ...
									  | ((0x10U 
										...
										!= (IData)(vlTOPp->PWMTest__DOT__value)) 
										& (IData)(vlTOPp->PWMTest__DOT___GEN_87)))))))))))))))))))))))))));
    vlTOPp->PWMTest__DOT___GEN_174 = ((~ (IData)(vlTOPp->PWMTest__DOT___T_9)) 
				      & ((0x29U == (IData)(vlTOPp->PWMTest__DOT__value)) 
					 | ((0x28U 
					     == (IData)(vlTOPp->PWMTest__DOT__value)) 
					    | ((0x27U 
							   ...
							   | ((0x22U 
								 ...
								 | ((0x20U 
									...
									== (IData)(vlTOPp->PWMTest__DOT__value)) 
								       | ((0x1eU 
									   == (IData)(vlTOPp->PWMTest__DOT__value)) 
									  | (IData)(vlTOPp->PWMTest__DOT___GEN_113))))))))))))));
    vlTOPp->PWMTest__DOT___T_502 = ((IData)(vlTOPp->PWMTest__DOT__c__DOT__out) 
				    == ((0x29U == (IData)(vlTOPp->PWMTest__DOT__value)) 
					| ((0x28U != (IData)(vlTOPp->PWMTest__DOT__value)) 
					   & ((0x27U 
					       != (IData)(vlTOPp->PWMTest__DOT__value)) 
...
void VPWMTest::_ctor_var_reset() {
    ...
    PWMTest__DOT___GEN_29 = VL_RAND_RESET_I(4);
    PWMTest__DOT___GEN_71 = VL_RAND_RESET_I(4);
    PWMTest__DOT___GEN_87 = VL_RAND_RESET_I(1);
    PWMTest__DOT___GEN_113 = VL_RAND_RESET_I(1);
    PWMTest__DOT___GEN_155 = VL_RAND_RESET_I(1);
    PWMTest__DOT___T_502 = VL_RAND_RESET_I(1);
    PWMTest__DOT___T_519 = VL_RAND_RESET_I(1);
    PWMTest__DOT___T_522 = VL_RAND_RESET_I(6);
    PWMTest__DOT___GEN_174 = VL_RAND_RESET_I(1);
